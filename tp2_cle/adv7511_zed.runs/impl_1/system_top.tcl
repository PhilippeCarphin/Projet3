...
set rc [catch {
  ...
  open_checkpoint C:/Temp/Tp2/tp2Code/adv7511_zed.runs/impl_1/system_top.dcp
  set_property webtalk.parent_dir C:/Temp/Tp2/tp2Code/adv7511_zed.cache/wt [current_project]
  set_property parent.project_path C:/Temp/Tp2/tp2Code/adv7511_zed.xpr [current_project]
  set_property ip_repo_paths {
  c:/Temp/Tp2/tp2Code/adv7511_zed.cache/ip
  C:/Temp/Tp2/tp2Code/library
} [current_project]
  set_property ip_output_repo c:/Temp/Tp2/tp2Code/adv7511_zed.cache/ip [current_project]
